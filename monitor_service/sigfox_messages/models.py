...
class Patient(models.Model):
  ...
  main_etelephone = models.CharField(max_length=50)
  second_etelephone = models.CharField(max_length=50)
...
class Emergency_Payload(models.Model):
  ...
  ereason_payload = models.CharField(max_length=3) # first payload of the emergency sent by the device ("yes/no")
...
class Attention_request(models.Model):
  ...
  emergency_biometrics = models.OneToOneField(Emergency_Biometrics, on_delete=models.SET_NULL, blank=True, null=True)
  patient = models.ForeignKey(Patient, on_delete=models.CASCADE)
  ...
  request_state = models.CharField(max_length=25)
